//! The `#[tool]` attribute macro: generates `Tool` trait implementations
//! from a struct definition and attribute parameters.
...
/// Generate a [`Tool`](agent_oxide::agent_oxide::tools::Tool) trait implementation for a struct.
///
/// # Parameters
///
/// | Key | Value | Required |
...
pub(crate) fn expand(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::agent_oxide::tools::Tool for #struct_name #ty_generics #where_clause {
            fn name(&self) -> &str {
                #name
            }
            ...
            fn parameter_schema(&self) -> ::agent_oxide::serde_json::Value {
                static SCHEMA: ::std::sync::OnceLock<::agent_oxide::serde_json::Value> =
                    ::std::sync::OnceLock::new();
                SCHEMA
                    .get_or_init(::agent_oxide::tools::generate_schema::<#args_type>)
                    .clone()
            }
            ...
            fn execute_stream(
                &self,
                raw_args: &str,
            ) -> ::std::result::Result<::agent_oxide::tools::ProgressStream, ::agent_oxide::tools::ToolError> {
                let args: #args_type = ::agent_oxide::serde_json::from_str(raw_args)
                    .map_err(|e| ::agent_oxide::tools::ToolError::InvalidArgs(
