...
fn validate_blueprint(agent: &FeedbackAgent) {
    ...
    let mut registry = agent_oxide::agent_kit::tools::ToolRegistry::new();
    agent_oxide::agent_kit::AgentBlueprint::blueprint_register_tools(agent, &mut registry);
    ...
    match first {
        Some(agent_oxide::agent_kit::tools::Progress::Done(out)) => {
