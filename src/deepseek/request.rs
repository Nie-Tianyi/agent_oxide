//! DeepSeek-specific request types — wraps [`CompletionRequest`](crate::provider::CompletionRequest)
//! with provider-specific fields (thinking, reasoning_effort, etc.).

use serde::Serialize;

use crate::provider::{CompletionRequest, Message, ReasoningEffort, ToolChoice, ToolDef};
