...
//!
//! This crate provides ready-to-use [`AgentHook`](crate::engine::AgentHook)
...
//! [`crate::engine::block_on`] for the LLM call — this blocks the agent task
//! but not the TUI, since they run on different threads.
//!
//! # Custom hooks
//!
//! Implement [`crate::engine::AgentHook`] directly for one-off behaviours.
//!
//! # Shared helpers
//!
